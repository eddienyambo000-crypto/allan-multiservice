...
export const IconTikTok = (p: P) => (
  <svg width={p.width ?? 20} height={p.height ?? 20} viewBox="0 0 24 24" fill="currentColor" {...p}>
    <path d="M16.5 3c.3 2.1 1.5 3.6 3.5 3.9v2.4c-1.2.1-2.4-.2-3.5-.8v5.9c0 3.2-2.5 5.6-5.6 5.6S5.3 17.6 5.3 14.5c0-3 2.3-5.4 5.3-5.6v2.5c-1.5.2-2.7 1.5-2.7 3.1 0 1.7 1.4 3.1 3.1 3.1s3.1-1.4 3.1-3.1V3h2.4Z" />
  </svg>
);
